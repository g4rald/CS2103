 ...
 * The user can begin manipulating the file with commands.
 * The program will save the given text file as long as the file contains text content.
 * Upon exiting the program, the given text file will be deleted if there are no text content within the file (i.e, file is empty).
 * Otherwise, the given text file is saved.
 * 
...
public class TextBuddy {
	...
	// to indicate if the line number to be deleted is invalid (negative number/wrong format)
	...
	// to indicate if the file does not content any text content (i.e file is empty)
	...
	// to indicate the updated text that will replace the text content in file (for delete command)
	...
	/**
	 * The program will check if arguments entered by user is valid.
	 * If so, welcome the user and start the program for user to input user commands.
	 */
	...
	/**
	 * Remove any leading/trailing whitespace of the text user entered.
	 * Add the text into file and update total lines in file.
	 */
	...
	/**
	 * Check whether the argument user entered beginning is valid.
	 * If invalid, show invalid message. 
	 * Otherwise, initialize the file for manipulation.
	 */
	...
	public static boolean fileExtensionWrong(String fileName) {
		return !(fileName.substring(((fileName.length()) - MINIMUM_FILE_LENGTH), fileName.length()).equalsIgnoreCase(".txt"));
	}
	...
	/**
	 * Check if the file contains any text content.
	 * If file is empty, display empty message. Otherwise, display file content.
	 */
	...
	/**
	 * Update the total lines in file first.
	 * Check if the user entered a valid line number (between 1 to total_lines, both inclusive).
	 */
	...
	/**
	 * Read line by line of the file and store into a string.
	 * If the line is what the user specified to delete, exclude the line from storing into the string.
	 * Update/Replace the file with the new updated string.
	 */
	public static void deleteLineAndUpdateFile(int lineToDelete) throws IOException {
	...
	/**
	 * Check if line to delete is a valid line.
	 * If so, delete the line and update the new file content.
	...
	/**
	 * Exit the program.
	 * If the given file is empty, delete it off from local disk.
	 * Otherwise, keep it saved in local disk.
	 */
	...
	/**
	 * Check whether the file is empty before getting the updated total lines in file.
	 */
	 ...
	 */
	public static void executeCommand(Scanner sc, String command) throws IOException {
